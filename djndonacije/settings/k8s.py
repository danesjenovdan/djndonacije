...
env = dict(
    ...
    DATABASE_NAME=os.getenv("DJANGO_DATABASE_NAME", "podpri"),
    DATABASE_USER=os.getenv("DJANGO_DATABASE_USER", "podpri"),
...
MAUTIC_SEGMENT_ID_USERS_WITHOUT_SEGMENT = os.getenv(
    "MAUTIC_SEGMENT_ID_USERS_WITHOUT_SEGMENT", 41
)
