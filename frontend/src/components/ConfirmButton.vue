<template>
  <dynamic-link :class="[
    ...
    <div class="hearts-left">
      <img class="" src="../assets/hearts.svg" />
    </div>
    <div v-if="arrow" class="arrow">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="30 18 110.9 40" fill="#fff">
        <path
    ...
    <div v-if="hearts" class="hearts">
      <div v-for="i in 3" :key="i" class="heart">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="8 0 92 100" fill="#fff">
          <path
    ...
    <div class="arrow-right">
      <img class="" src="../assets/arrow-right.svg" />
    </div>
  </dynamic-link>
</template>
