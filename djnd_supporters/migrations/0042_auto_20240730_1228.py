    ...
    operations = [
        migrations.AddField(
            ...
            field=models.URLField(
                blank=True,
                help_text="Povezava do CSS datoteke s stili za frontend",
                null=True,
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                blank=True,
                null=True,
                verbose_name="Mautic email ID za braintree donacijo",
            ),
        ),
        migrations.AlterField(
            model_name="donationcampaign",
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                blank=True,
                null=True,
                verbose_name="Mautic ID emaila za urejanje naročnine",
            ),
        ),
        migrations.AlterField(
            model_name="donationcampaign",
        ...
        migrations.AlterField(
            ...
            name="has_upn",
            field=models.BooleanField(
                default=True, verbose_name="Sprejemamo UPN donacije?"
            ),
        ),
        migrations.AlterField(
            model_name="donationcampaign",
            name="name",
            field=models.CharField(
                max_length=128, verbose_name="Ime donacijske kampanje"
            ),
        ),
        migrations.AlterField(
            model_name="donationcampaign",
            name="segment",
            field=models.IntegerField(
                blank=True, null=True, verbose_name="Mautic segment ID"
            ),
        ),
        migrations.AlterField(
            model_name="donationcampaign",
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                blank=True, null=True, verbose_name="Mautic email ID za UPN donacijo"
            ),
        ),
        migrations.AlterField(
            model_name="donationcampaign",
