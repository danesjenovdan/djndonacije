        ...
        (
            "Donacije",
            {
                "fields": [
                    ...
                    "flik_subscription_timeout_email_template",
...
class TransactionAdmin(ImportExportModelAdmin):
    ...
    readonly_fields = ("subscriber", "transaction_id", "amount", "address", "created",)
    list_display = (
        "amount",
        "subscriberName",
        "address",
...
class BraintreeApiAdmin(admin.ModelAdmin):
    list_display = ("name", "account", "export_link")
    search_fields = ["name", "account__name"]
    autocomplete_fields = ["account"]

    def export_link(self, obj):
        url = reverse("supporters:transaction-export", args=[obj.id])
